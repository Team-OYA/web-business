            ...
            <section style={{ position: 'relative', zIndex: 2 }}>
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0" style={{ position: 'relative' }}>
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8 z-40">
                            <h1 className="text-center font-bold leading-tight tracking-tight text-white text-5xl">
                                THE POP
                            </h1>
                            <div className="flex flex-row items-center justify-center pt-8 z-50">

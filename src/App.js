...
import ChatRoomDetail from "./components/common/Chat/ChatRoomDetail";
        ...
        <BrowserRouter>
            <Main>
                <Routes>
                    ...
                    {generateRoute(businessColor, businessSideBarColor, businessSideBarList, businessHomeUrl, "/chat/:roomId", ChatRoomDetail)}
                    ...
                    {generateRoute(adminColor, adminSideBarColor, adminSideBarList, adminHomeUrl, '/admin/chat/:roomId', ChatRoomDetail)}
                </Routes>
            </Main>
